...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    ...
                    // n selected 表示部分(modify)
                    if (options.length > this.numberDisplayed) {
                        //add
                        if(this.displaySelectedCount) {
            ...
            templates: {
                ...
                li: '<li><a href="javascript:void(0);"><label></label></a></label></a></li>',
                divider: '<li class="multiselect-item divider"></li>',
                liGroup: '<li class="multiselect-item group" style="margin:5px; text-align:center"><label class="multiselect-group"></label></li>'
            }
        },
        ...
        uncheckRadio: function() { 
            $('#download').parents().find('input[type="radio"]').each(function(){
              if( $(this).attr('id') == "all" || $(this).attr('id') == "diselect" ) {
        ...
        checkBox: function(element){
          ...
          element.parents('ul').find('input').each(function(){
            ...
            if($(this).attr('type') == "checkbox") {
              ...
              $(this).prop('checked', false) 
                ...
                if(id == "all") {
                  ...
                  //regexp
                  var reg = new RegExp("^" + element.attr('id'));
        ...
        createOptionValue: function(element) {
            ...
            //add(radiobox)
            if( $(element).attr('id') == "jsRadio") {
              $('label', $li).append('<input type="radio" id=' + value + ' name="' + this.options.checkboxName + '" />');
            //default 
            } else {
        ...
        getSelected: function() {
            //return $('option:not([value="' + this.options.selectAllValue + '"])', $('option:not([id="jsRadio"]'), this.$select).filter(":selected");
